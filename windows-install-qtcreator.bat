powershell.exe -Command "(New-Object System.Net.WebClient).DownloadFile(\"https://download.qt.io/official_releases/qtcreator/4.10/4.10.2/qt-creator-opensource-windows-x86_64-4.10.2.exe\", \"qtcreator.exe\")"
...
powershell.exe -Command "(Get-Content install-qtcreator.qs).replace('$OUTPUT', [regex]::escape('%CD%\qtcreator-4.10.2')) | Set-Content install-qtcreator.qs"
